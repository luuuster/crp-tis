...
> ⚠️ Esta pasta é **histórico de processo**, **não** onboarding. São registros datados — podem estar
> desatualizados. Não trate como instrução vigente.
...
| `referencias-a11y-ux/` | material de referência (WCAG, heurísticas, MDN) |
