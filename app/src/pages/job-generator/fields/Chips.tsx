...
export function Chips({ value, onChange, pool, addLabel = 'adicionar', emptyHint, searchPlaceholder = 'Buscar…', ordered, "aria-invalid": ariaInvalid, "aria-describedby": ariaDescribedby, "aria-labelledby": ariaLabelledby }: {
          ...
          {value.length > 0 && (
            <div className="shrink-0 border-t border-border/60 p-2">
              <ConfirmDialog
                ...
                title="Limpar todos os itens?" description={`Os ${value.length} itens deste campo serão removidos.`}
                confirmLabel="Limpar tudo" onConfirm={() => onChange([])}
                trigger={
