      ...
      <aside className="space-y-4 lg:sticky lg:top-4" aria-label="Ações">
        ...
        <div className="space-y-2">
          ...
          <ConfirmDialog
            ...
            title="Começar uma nova vaga?"
            description="Os dados preenchidos nesta vaga serão descartados e não poderão ser recuperados."
            confirmLabel="Sim, recomeçar" onConfirm={onNova}
            trigger={<Button variant="outline" className="w-full"><Plus aria-hidden /> Nova vaga</Button>}
          />
        </div>
      </aside>
    </div>
