...
export const CANDIDATOS_INICIAL: Candidato[] = [
  { id: '1', nome: 'Mariana Lopes', email: 'mariana.lopes@example.com', vaga: 'Desenvolvedor Full Stack', senioridade: 'Sênior', etapa: 'Contratado', score: 92, atualizado: 'há 3 dias' },
  { id: '2', nome: 'Jair Carmona', email: 'jair.carmona@example.com', vaga: 'Desenvolvedor Backend', senioridade: 'Pleno', etapa: 'Entrevista Gestor', score: 82, atualizado: 'ontem' },
  { id: '3', nome: 'Diego Teixeira', email: 'diego.teixeira@example.com', vaga: 'Product Manager', senioridade: 'Sênior', etapa: 'Entrevista RH', score: 68, atualizado: 'há 2 h' },
  { id: '4', nome: 'Rodrigo Alves', email: 'rodrigo.alves@example.com', vaga: 'UX Designer III', senioridade: 'Sênior', etapa: 'Teste Técnico', score: 74, atualizado: 'há 5 h' },
  { id: '5', nome: 'Carla Mendonça', email: 'carla.mendonca@example.com', vaga: 'Engenheiro de Dados', senioridade: 'Pleno', etapa: 'Entrevista Gestor', score: 88, atualizado: 'ontem' },
  { id: '6', nome: 'Felipe Santos', email: 'felipe.santos@example.com', vaga: 'Analista de QA', senioridade: 'Júnior', etapa: 'Triagem IA', score: 65, atualizado: 'há 1 dia' },
  { id: '7', nome: 'Bianca Ferreira', email: 'bianca.ferreira@example.com', vaga: 'Desenvolvedor Backend', senioridade: 'Sênior', etapa: 'Contratado', score: 95, atualizado: 'há 1 semana' },
  { id: '8', nome: 'Gustavo Pereira', email: 'gustavo.pereira@example.com', vaga: 'Product Manager', senioridade: 'Sênior', etapa: 'Reprovado', score: 58, atualizado: 'há 4 dias' },
  { id: '9', nome: 'Larissa Castro', email: 'larissa.castro@example.com', vaga: 'Cientista de Dados', senioridade: 'Sênior', etapa: 'Entrevista Gestor', score: 84, atualizado: 'ontem' },
  { id: '10', nome: 'Vitor Hugo', email: 'vitor.hugo@example.com', vaga: 'DevOps Engineer', senioridade: 'Sênior', etapa: 'Entrevista RH', score: 79, atualizado: 'há 3 h' },
  { id: '11', nome: 'Aline Ramos', email: 'aline.ramos@example.com', vaga: 'Tech Lead Frontend', senioridade: 'Sênior', etapa: 'Contratado', score: 90, atualizado: 'há 2 semanas' },
  { id: '12', nome: 'Daniel Moreira', email: 'daniel.moreira@example.com', vaga: 'Desenvolvedor Mobile', senioridade: 'Pleno', etapa: 'Banco de Talentos', score: 62, atualizado: 'há 1 mês' },
  { id: '13', nome: 'Patrícia Lima', email: 'patricia.lima@example.com', vaga: 'UX Designer III', senioridade: 'Pleno', etapa: 'Reprovado', score: 49, atualizado: 'há 5 dias' },
  { id: '14', nome: 'Ricardo Nunes', email: 'ricardo.nunes@example.com', vaga: 'Analista de QA', senioridade: 'Júnior', etapa: 'Triagem IA', score: 71, atualizado: 'há 2 dias' },
  { id: '15', nome: 'Sofia Martins', email: 'sofia.martins@example.com', vaga: 'Desenvolvedor Mobile', senioridade: 'Pleno', etapa: 'Teste Técnico', score: 80, atualizado: 'há 6 h' },
  { id: '16', nome: 'Gabriel Costa', email: 'gabriel.costa@example.com', vaga: 'Analista de Marketing', senioridade: 'Pleno', etapa: 'Banco de Talentos', score: 55, atualizado: 'há 2 meses' },
  { id: '17', nome: 'Juliana Reis', email: 'juliana.reis@example.com', vaga: 'Product Manager', senioridade: 'Pleno', etapa: 'Triagem IA', score: 73, atualizado: 'há 1 dia' },
  { id: '18', nome: 'Thiago Barros', email: 'thiago.barros@example.com', vaga: 'Arquiteto de Software', senioridade: 'Sênior', etapa: 'Entrevista Gestor', score: 86, atualizado: 'ontem' },
  { id: '19', nome: 'Rafael Tavares', email: 'rafael.tavares@example.com', vaga: 'DevOps Engineer', senioridade: 'Sênior', etapa: 'Banco de Talentos', score: 77, atualizado: 'há 3 semanas' },
  { id: '20', nome: 'Letícia Gomes', email: 'leticia.gomes@example.com', vaga: 'Cientista de Dados', senioridade: 'Pleno', etapa: 'Banco de Talentos', score: 70, atualizado: 'há 1 mês' },
  { id: '21', nome: 'Pedro Antunes', email: 'pedro.antunes@example.com', vaga: 'Scrum Master', senioridade: 'Sênior', etapa: 'Reprovado', score: 60, atualizado: 'há 6 dias' },
  { id: '22', nome: 'Helena Castro', email: 'helena.castro@example.com', vaga: 'Tech Lead Frontend', senioridade: 'Sênior', etapa: 'Entrevista RH', score: 83, atualizado: 'há 4 h' },
  { id: '23', nome: 'Bruno Lima', email: 'bruno.lima@example.com', vaga: 'Engenheiro de Dados', senioridade: 'Pleno', etapa: 'Contratado', score: 91, atualizado: 'há 2 semanas' },
  { id: '24', nome: 'Ana Souza', email: 'ana.souza@example.com', vaga: 'Analista de QA', senioridade: 'Pleno', etapa: 'Banco de Talentos', score: 64, atualizado: 'há 1 mês' },
]
