...
import { PageContainer, PageHeader, Panel, StatCard, DetailScreen, Paginacao, EmptyState, TableSkeleton, ErrorState, badgeTone, type BadgeTone } from '@/components/composicoes/page'
