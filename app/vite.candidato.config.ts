...
const ROTAS_CANDIDATO = new Set(['/', '/index.html', '/descricao_da_vaga', '/inscricao_da_vaga', '/linkpublico', '/linkpublico/inscricao_na_vaga', '/linkpublico/inscricao_na_vaga/inscricao_enviada', '/acesso', '/acesso/recuperar', '/acesso/recuperar/enviado', '/redefinir_senha', '/redefinir_senha/sucesso', '/cadastro', '/painel'])
